...
export async function create(req: Request, res: Response) {
  ...
  const comment = await commentService.createComment(req.params.updateId as string, req.user!.userId, data.content, data.parentId);
...
export async function list(req: Request, res: Response) {
  ...
  const result = await commentService.getComments(req.params.updateId as string, cursor, limit, req.user?.userId);
