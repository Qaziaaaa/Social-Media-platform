...
export async function create(req: Request, res: Response) {
  ...
  const comment = await commentService.createComment(req.params.postId as string, req.user!.userId, data.content);
...
export async function list(req: Request, res: Response) {
  ...
  const result = await commentService.getComments(req.params.postId as string, cursor, limit);
